function Info() {
    return(
        <div className="plot" style={{justifyContent: 'center'}}>
            <svg style={{width: '15%'}} xmlns="http://www.w3.org/2000/svg" id="car.info.steeringangle" xmlnsXlink="http://www.w3.org/1999/xlink" 
